# Project Vision & Scope: inkMOD

The goal of this InkMOD fork is to provide useful enhancements while still adhering to the core principles of InkMOD. If you have a major feature request, it should first be directed at the main project since this is a downstream project that consumes their updates.

The content below is taken directly from InkMOD and aligns with inkMOD's vision as well.
...
*These features align with InkMOD's goals but are impractical on the current hardware or produce poor UX.*
