/* bidiclasses.t — bidi class table for InkMOD Hebrew/English epub.
 *
 * Coverage rationale:
 *   Hebrew + English is the primary target. However, InkMOD renders
 ...
 *   scripts InkMOD's fonts don't support (CJK, Arabic, Devanagari, etc.)
...
/* ── Cyrillic (L) ────────────────────────────────────────────────────── */
/* Required: InkMOD supports Russian, Ukrainian, Bulgarian, etc.
...
/* Covers accented chars for Vietnamese, Welsh, Romanian, etc.
   Not currently rendered by InkMOD fonts, but costs only 2 table rows. */
{0x1E00, 0x1EFF, L},
