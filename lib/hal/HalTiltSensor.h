...
// TODO: Move enums into new header and share with InkMODSettings.h
namespace InkMODOrientation {
enum Value : uint8_t { PORTRAIT = 0, LANDSCAPE_CW = 1, INVERTED = 2, LANDSCAPE_CCW = 3 };
}

namespace InkMODTiltPageTurn {
enum Value : uint8_t { TILT_OFF = 0, TILT_ON = 1 };
}

namespace InkMODTiltPageTurnDirection {
enum Value : uint8_t {
  TILT_LEFT_RIGHT = 0,
