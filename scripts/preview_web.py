...
PAGES = {
    "home":     ("/",         "inkMOD",                   "home",     ""),
    "files":    ("/files",    "Files - inkMOD",           "files",    '  <script src="/js/jszip.min.js"></script>'),
    "settings": ("/settings", "Settings - inkMOD Reader", "settings", ""),
    "fonts":    ("/fonts",    "Fonts - inkMOD",           "fonts",    ""),
}
...
if __name__ == "__main__":
    ...
    print(f"inkMOD web preview: http://localhost:{port}  (Ctrl+C to stop)")
    try:
        httpd.serve_forever()
