...
// File paths
constexpr char WIFI_FILE_BIN[] = "/.inkmod/wifi.bin";
constexpr char WIFI_FILE_JSON[] = "/.inkmod/wifi.json";
constexpr char WIFI_FILE_BAK[] = "/.inkmod/wifi.bin.bak";

// Legacy obfuscation key - "InkMOD" in ASCII (only used for binary migration)
