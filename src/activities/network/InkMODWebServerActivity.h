...
#include "network/InkMODWebServer.h"
...
/**
 * InkMODWebServerActivity is the entry point for file transfer functionality.
 * It:
 ...
 * - Starts the InkMODWebServer when connected
 * - Handles client requests in its loop() function
 * - Cleans up the server and shuts down WiFi on exit
 */
class InkMODWebServerActivity final : public Activity {
  ...
  std::unique_ptr<InkMODWebServer> webServer;
 ...
 public:
  explicit InkMODWebServerActivity(GfxRenderer& renderer, MappedInputManager& mappedInput,
                                       std::string returnBookPath = {})
      : Activity("InkMODWebServer", renderer, mappedInput), returnBookPath(std::move(returnBookPath)) {}
  InkMODWebServerActivity(GfxRenderer& renderer, MappedInputManager& mappedInput, NetworkMode initialNetworkMode,
                              std::string returnBookPath = {})
      : Activity("InkMODWebServer", renderer, mappedInput),
