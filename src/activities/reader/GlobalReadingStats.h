...
struct GlobalReadingStats {
  ...
  // Loads stats from /.inkmod/global_stats.bin. Returns default-constructed
  ...
  // from /.inkmod/synced_stats/. A stale file matching this device's MAC is
  ...
  // Saves stats to /.inkmod/global_stats.bin.
  void save() const;

  // Replaces /.inkmod/global_stats.bin with a fresh empty file without
